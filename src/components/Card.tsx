    ...
    return(
        ...
        >
            ...
            <Card ref={scope}  shadow="sm" padding="lg" radius="lg"sx={{width:"25em",height:"35em"}}>
                ...
                <Card.Section  sx={{display:"flex", justifyContent:"center", alignItems:"center", flexDirection:"column",backgroundColor:"#fff",borderRadius:"10px 10px 0 0", boxShadow:"0 -7px 15px 0 #CCCCCC33", padding:"1rem", zIndex:100}} pos={"relative"}>

                    <Text variant="h1" size={30} weight={500}>{title}</Text>
